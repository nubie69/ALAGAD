  ...
  toVectorDocument(chunk, embedding, lastIndexedIso) {
    ...
    return {
      ...
      metadata: {
        ...
        verification_status: chunk?.metadata?.verification_status,
        verified_by: chunk?.metadata?.verified_by,
        verified_at: chunk?.metadata?.verified_at,
        source_office: chunk?.metadata?.source_office,
        stakeholder: chunk?.metadata?.stakeholder,
        stakeholders: chunk?.metadata?.stakeholders,
        deadline: chunk?.metadata?.deadline,
